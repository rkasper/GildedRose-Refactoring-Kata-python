...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_system_lowers_both_values_for_every_item(self):
        ...
        """
        items: List[Item] = [NormalItem("foo", 7, 11), NormalItem("bar", 23, 42)]
    ...
    def test_quality_degrades_twice_as_fast(self):
        ...
        items: List[Item] = [NormalItem("foo", 0, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_aged_brie_increases_in_quality(self):
        ...
        items: List[Item] = [AgedBrie("Aged Brie", 7, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_aged_brie_quality_increases_by_2_when_past_sellin_date(self):
        ...
        items: List[Item] = [AgedBrie("Aged Brie", 0, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_sulfuras_never_has_to_be_sold_or_decreases_in_quality(self):
        ...
        items: List[Item] = [Sulfuras("Sulfuras, Hand of Ragnaros", 7, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        ...
        # edge case
        items = [Sulfuras("Sulfuras, Hand of Ragnaros", -1, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(11, items[0].quality)
    ...
    def test_backstage_passes(self):
        ...
        items: List[Item] = [BackstagePasses("Backstage passes to a TAFKAL80ETC concert", 42, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(12, items[0].quality)
    ...
    def test_backstage_passes_edge_cases(self):
        ...
        items: List[Item] = [BackstagePasses("Backstage passes to a TAFKAL80ETC concert", 10, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(50, items[0].quality)

        items = [BackstagePasses("Backstage passes to a TAFKAL80ETC concert", 5, 48)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(50, items[0].quality)
    ...
    def test_conjured_item(self):
        ...
        items: List[Item] = [Conjured("Conjured", 7, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(6, items[0].sell_in)
        self.assertEqual(9, items[0].quality)
