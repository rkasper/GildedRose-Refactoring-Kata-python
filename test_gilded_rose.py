...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_system_lowers_both_values_for_every_item(self):
        ...
        """
        items: List[Item] = [Item.create_normal_item(7, 11), Item.create_normal_item(23, 42)]
    ...
    def test_quality_degrades_twice_as_fast(self):
        ...
        items: List[Item] = [Item.create_normal_item(0, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_quality_is_never_negative(self):
        ...
        items: List[Item] = [Item.create_normal_item(7, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(0, items[0].quality)

        items = [Item.create_normal_item(-1, 0)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(0, items[0].quality)
    ...
    def test_aged_brie_increases_in_quality(self):
        ...
        items: List[Item] = [Item.create_aged_brie(7, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_aged_brie_quality_increases_by_2_when_past_sellin_date(self):
        ...
        items: List[Item] = [Item.create_aged_brie(0, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_aged_brie_quality_is_never_more_than_50(self):
        ...
        items: List[Item] = [Item.create_aged_brie(-1, 50)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
    ...
    def test_quality_is_never_more_than_50(self):
        ...
        items: List[Item] = [Item.create_aged_brie(7, 50)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(50, items[0].quality)
    ...
    def test_sulfuras_never_has_to_be_sold_or_decreases_in_quality(self):
        ...
        items: List[Item] = [Item.create_sulfuras(7, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        ...
        # edge case
        items = [Item.create_sulfuras(-1, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(11, items[0].quality)
    ...
    def test_backstage_passes(self):
        ...
        items: List[Item] = [Item.create_backstage_passes(42, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(12, items[0].quality)

        items = [Item.create_backstage_passes(10, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(13, items[0].quality)

        items = [Item.create_backstage_passes(5, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(14, items[0].quality)

        items = [Item.create_backstage_passes(0, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(0, items[0].quality)
    ...
    def test_backstage_passes_edge_cases(self):
        ...
        items: List[Item] = [Item.create_backstage_passes(10, 49)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(50, items[0].quality)

        items = [Item.create_backstage_passes(5, 48)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(50, items[0].quality)
    ...
    def test_conjured_item(self):
        ...
        items: List[Item] = [Item.create_conjured(7, 11)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_inventory()
        self.assertEqual(6, items[0].sell_in)
        self.assertEqual(9, items[0].quality)
